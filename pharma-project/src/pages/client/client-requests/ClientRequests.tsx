...
import AdminNavbar from "../../../components/AdminNavbar"; // Asegúrate de ajustar la ruta si es necesario
...
export default function ClientRequests() {
    ...
    return (
        <div className="flex flex-col justify-start items-center w-full">
            <AdminNavbar /> {/* Agregamos el navbar aquí */}
            <Title title="My Requests" green="1" className="p-5" />
            ...
            <div className="flex flex-col gap-3 overflow-auto h-96">
                {/* Define una altura para el contenedor */}
