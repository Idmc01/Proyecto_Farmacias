export default function ClientRecuperar() {
    return (
        <div className='flex flex-col justify-center items-center w-full h-screen'>
            ...
            <div className='flex flex-col gap-3 w-96'>
                ...
                <input type="text" placeholder="Códifo" className="border border-green-1 p-2 text-lg rounded bg-green-1" />
                <button className="bg-orange-500 text-white rounded p-2 text-lg">Continuar</button>
